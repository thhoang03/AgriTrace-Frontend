  ...
  return (
    <div className="min-h-screen" style={{ background: "#F5F7FA" }}>
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto py-20">
          ...
          <div className="max-w-lg mx-auto">
            <div className="flex gap-2 p-2 rounded-2xl" style={{ background: "rgba(255,255,255,0.95)", backdropFilter: "blur(12px)", boxShadow: "0 8px 32px rgba(0,0,0,0.2)" }}>
              ...
              <button onClick={handleSearch} className="px-5 py-3 rounded-xl text-white text-sm font-semibold transition-all hover:opacity-90 flex items-center gap-2" style={{ background: "#2E7D32", whiteSpace: "nowrap" }}>
                <Search className="w-4 h-4" /> Search
              </button>
              <button className="px-4 py-3 rounded-xl text-sm font-semibold border flex items-center gap-2" style={{ border: "1px solid #e0e0e0", color: "#444", whiteSpace: "nowrap" }}>
      ...
      <section id="features" className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            <span className="text-sm font-semibold px-3 py-1 rounded-full" style={{ background: "#E8F5E9", color: "#2E7D32" }}>Platform Features</span>
            <h2 className="mt-3 text-gray-900" style={{ fontSize: 32, fontWeight: 700 }}>End-to-End Transparency</h2>
            <p className="text-gray-500 mt-2 max-w-lg mx-auto">From seed to shelf, every step of your agricultural product journey is recorded, verified, and accessible.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map(({ icon: Icon, title, desc, color, bg }) => (
              <div key={title} className="p-6 rounded-2xl bg-white group hover:-translate-y-1 transition-all duration-200 cursor-pointer" style={{ boxShadow: "0 2px 12px rgba(0,0,0,0.06)", border: "1px solid rgba(0,0,0,0.05)" }}>
                ...
                <div className="flex items-center gap-1 mt-4 font-medium" style={{ color, fontSize: 13 }}>Learn more <ChevronRight className="w-3.5 h-3.5" /></div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="stats" className="py-16 px-6" style={{ background: "linear-gradient(135deg, #1B5E20 0%, #2E7D32 100%)" }}>
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-white" style={{ fontSize: 30, fontWeight: 700 }}>Trusted Nationwide</h2>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            <span className="text-sm font-semibold px-3 py-1 rounded-full" style={{ background: "#E8F5E9", color: "#2E7D32" }}>How It Works</span>
      ...
      <section id="partners" className="py-16 px-6 border-t border-gray-100">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6">
            {partners.map((p) => (
              <div key={p} className="px-6 py-3 rounded-xl bg-white font-semibold text-gray-500 hover:text-gray-800 transition-colors" style={{ boxShadow: "0 1px 6px rgba(0,0,0,0.06)", fontSize: 14 }}>
                {p}
              </div>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div className="md:col-span-2">
              ...
              <p className="text-green-200 text-sm leading-relaxed max-w-xs">Official agricultural traceability platform by the Ministry of Agriculture and Rural Development of Vietnam.</p>
            </div>
            <div>
