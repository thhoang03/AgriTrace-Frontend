  ...
  return (
    <div className="min-h-screen flex" style={{ background: "#F5F7FA" }}>
      ...
      <div className="flex flex-col w-full max-w-md mx-auto lg:mx-0 lg:w-[440px] p-8 justify-center">
        ...
        {/* <div className="mt-6 p-4 rounded-xl text-sm" style={{ background: "#E8F5E9", border: "1px solid #C8E6C9" }}>
          <div className="font-medium text-green-800 mb-1">Demo credentials</div>
          <div className="text-green-700">Username: <code className="bg-white px-1 rounded">admin</code></div>
          <div className="text-green-700">Password: <code className="bg-white px-1 rounded">password123</code></div>
        </div> */}
