...
import { batches, type BatchStatus } from "../../lib/data/mockData";
        ...
        <div className="bg-white rounded-2xl overflow-hidden" style={{ boxShadow: "0 2px 12px rgba(0,0,0,0.06)" }}>
                    ...
                    >
                      <td className="px-4 py-3.5">
                        <div className="flex items-center gap-3">
                          <img src={batch.image} alt={batch.product} className="w-9 h-9 rounded-xl object-cover flex-shrink-0" />
                          <div>
                      ...
                      <td className="px-4 py-3.5">
                        <div className="flex items-center gap-2">
                          ...
                          <button onClick={(e) => { e.stopPropagation(); setShowQR(batch.id); }} className="p-1 rounded-lg hover:bg-gray-100">
                      ...
                      <td className="px-4 py-3.5">
                        <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                          <button onClick={(e) => { e.stopPropagation(); navigate(`/app/batches/${batch.id}`); }} className="p-1.5 rounded-lg hover:bg-blue-50 text-blue-500 transition-colors" title="View">
                            <Eye className="w-4 h-4" />
                          </button>
                          <button onClick={(e) => e.stopPropagation()} className="p-1.5 rounded-lg hover:bg-green-50 text-green-600 transition-colors" title="Edit">
                            <Edit2 className="w-4 h-4" />
                          </button>
                          <button onClick={(e) => e.stopPropagation()} className="p-1.5 rounded-lg hover:bg-red-50 text-red-500 transition-colors" title="Delete">
          ...
          <div className="flex items-center justify-between px-6 py-4 border-t border-gray-100">
            ...
            <div className="flex items-center gap-1">
              <button onClick={() => setPage(Math.max(1, page - 1))} disabled={page === 1} className="p-2 rounded-lg hover:bg-gray-100 disabled:opacity-40 disabled:cursor-not-allowed transition-colors">
              ...
              <button onClick={() => setPage(Math.min(totalPages || 1, page + 1))} disabled={page === (totalPages || 1)} className="p-2 rounded-lg hover:bg-gray-100 disabled:opacity-40 disabled:cursor-not-allowed transition-colors">
