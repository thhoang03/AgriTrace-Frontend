...
const BANNER_IMG =
  "https://images.unsplash.com/photo-1777058019293-73d54d4c4cae?w=1400&q=80";
...
function formatRelativeTime(dateStr: string, lang: string = "en"): string {
  ...
  return date.toLocaleDateString(lang === "vi" ? "vi-VN" : "en-VN", {
    day: "numeric",
    month: "short",
  });
}
...
export function DashboardPage() {
  ...
  const quickActions = [
    {
      label: lang === "vi" ? "Tạo Lô Hàng" : "Create Batch",
      icon: Plus,
      color: "#2E7D32",
      bg: "#E8F5E9",
      to: "/app/batches",
    ...
    {
      label: lang === "vi" ? "Tạo Mã QR" : "Generate QR",
      icon: QrCode,
      color: "#1976D2",
      bg: "#E3F2FD",
      to: "/app/batches",
    ...
    {
      label: lang === "vi" ? "Kiểm Định" : "Inspection",
      icon: FlaskConical,
      color: "#F57C00",
      bg: "#FFF3E0",
      to: "/app/inspection",
  ...
  const statCards = overview
    ? [
        {
          label: lang === "vi" ? "Tổng Lô Hàng" : "Total Batches",
        ...
        ...(isAdmin
          ? [
              {
                label: lang === "vi" ? "Tổ Chức" : "Organizations",
          ...
          : []),
        {
          label: lang === "vi" ? "Tổng Sự Kiện" : "Total Events",
        ...
        {
          label: lang === "vi" ? "Lệnh Thu Hồi" : "Total Recalls",
        ...
        {
          label: lang === "vi" ? "Lô Bị Thu Hồi" : "Recalled Batches",
          value: overview.recalledBatches.toLocaleString(),
          change: overview.recalledBatches > 0 ? "+2" : "0",
          up: false,
          icon: AlertTriangle,
          color: "#E53935",
          bg: "#FFEBEE",
      ...
      <div className="pb-8">
        <div className="relative h-44 overflow-hidden">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, rgba(27,94,32,0.92) 0%, rgba(46,125,50,0.75) 60%, rgba(0,0,0,0.3) 100%)",
            }}
          />
          ...
          <div className="ml-auto hidden md:flex items-center gap-4">
            ...
            <div className="text-right text-green-100 text-sm">
              ...
              <div className="text-white font-semibold">
                {now.toLocaleDateString(lang === "vi" ? "vi-VN" : "en-VN", {
                  weekday: "long",
                  day: "numeric",
                  month: "long",
                  year: "numeric",
      ...
      <div className="px-6 -mt-6 relative z-10">
            ...
            ({ label, value, change, up, icon: Icon, color, bg }) => (
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <div
                    className={`flex items-center gap-0.5 text-xs font-semibold px-1.5 py-0.5 rounded-full ${up ? "bg-green-50 text-green-700" : "bg-red-50 text-red-600"}`}
                  >
                    {up ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 mb-5">
          ...
          >
            ...
            {overview?.monthlyProduction &&
            overview.monthlyProduction.length > 0 ? (
              <ResponsiveContainer width="100%" height={210}>
                <BarChart
                  data={overview.monthlyProduction}
                  barSize={16}
                  barGap={4}
                >
                  <CartesianGrid
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-5">
          ...
          >
            ...
            {overview?.inspectionResults &&
            overview.inspectionResults.length > 0 ? (
              <ResponsiveContainer width="100%" height={180}>
                <BarChart
                  data={overview.inspectionResults}
                  barSize={14}
                  barGap={3}
                >
                  <CartesianGrid
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="font-semibold text-red-800 text-sm">
                      {lang === "vi"
                        ? "Cảnh Báo Thu Hồi Đang Hoạt Động"
                        : "Active Recall Alert"}
                    </div>
                    <p className="text-red-600 text-xs mt-1 leading-relaxed">
                      {lang === "vi"
                        ? `${overview.totalRecalls} lệnh thu hồi cần xử lý.`
